...
strMoveNumber = input.question("Number of characters to move to the end: ");
strMoveNumber = Number(strMoveNumber);
...
if (strMoveNumber < str.lenght){
  ...
  newStr = prefix + suffix;
  console.log(`Your number was too high! System defaults to 3 characters. ${str} becomes ${newStr}.`);
}